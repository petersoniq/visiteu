...
export function RegisterForm() {
  ...
  if (success) {
    return (
      <div className="w-full max-w-sm mx-auto text-center">
        <h1 className="text-2xl font-bold text-ink mb-2">Skoro hotovo! 🎉</h1>
  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      <h1 className="text-2xl font-bold text-ink mb-1">Registrácia</h1>
      <p className="text-ink-muted mb-6">Začni zaznamenávať svoje cesty po EÚ</p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-ink-secondary mb-1">Potvrď heslo</label>
