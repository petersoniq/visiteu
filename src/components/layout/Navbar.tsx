      ...
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {profile?.is_admin && (
            <Link
              to="/admin"
              className="flex items-center gap-1.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-accent"
            >
          ...
          <Link
            to="/profile"
            className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300 hover:text-accent transition"
          >
