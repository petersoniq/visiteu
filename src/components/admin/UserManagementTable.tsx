          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                ...
                <td className="px-4 py-3 text-slate-500 dark:text-slate-400">{format(new Date(u.created_at), 'd.M.yyyy')}</td>
                ...
                <td className="px-4 py-3 text-center">
                  {u.is_admin ? (
                    ...
                    <span className="inline-flex items-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-2 py-0.5 text-xs font-medium">
                      Člen
                    </span>
                  )}
                </td>
